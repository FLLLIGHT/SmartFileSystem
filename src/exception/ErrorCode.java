...
public class ErrorCode extends RuntimeException{
    ...
    public static final int BLOCK_ALREADY_EXISTED = 4;

    public static final int FILE_META_NOT_EXISTED = 5;
    public static final int BLOCK_META_NOT_EXISTED = 6;
    public static final int BLOCK_DATA_NOT_EXISTED = 7;
    public static final int ID_DATA_NOT_EXISTED = 8;

    public static final int FILE_NOT_EXISTED = 9;
    public static final int BLOCK_NOT_EXISTED = 10;

    public static final int SETTING_FILE_ERROR = 11;
